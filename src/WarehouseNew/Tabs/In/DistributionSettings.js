...
const DistributionSettings = props => {
  ...
  const [courier, setCourier] = useState(
    props.data &&
      ...
      props.data.externalData.distributionSettings &&
      props.data.externalData.distributionSettings.courier
      ? props.data.externalData.distributionSettings.courier
      : 0
  );
  ...
  return (
    <div className='container-modal flexCentered' id='container-modal'>
      <div className='width800px height600px backgroundWhite zindexUpMost borderRadius2px positionRelative'>
        <div
          className='height80px positionAbsoluteTop'
        ...
        <div
          className='height80px positionAbsoluteBottom'
          style={{
            display: 'flex',
            alignItems: 'flex-end',
            right: '0',
        ...
        >
          ...
          >
            <button
              ...
              className='button large marginleft1rem'
              onClick={() => props.setDistributionSettings(false)}
            >
              Цуцлах
            </button>
            <button
              disabled={saving ? true : false}
              className='button primary large margingright1rem'
              onClick={() => save()}
            >
              Хадгалах
            </button>
