					...
					<div className="right padding2rem" style={{ left: '400px', overflow: 'auto' }}>
						...
						<div style={{ border: '1px solid #eee' }} id="productList">
							<div className="blah" style={{ background: '#f6f6f6' }}>
								...
								<div className="blahblah"><div className="width300px"><p>Нэр</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Ангилал</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Баркод</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Хэлбэр</p></div></div>
								<div className="blahblah"><div className="width120px"><p>SKU</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Татах тоо</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Өртөг</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Нийт өртөг</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Хямдралын хувь</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Хямдралын дүн</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Төлөх дүн</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Зарах үнэ</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Сери</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Сери +</p></div></div>
								<div className="blahblah"><div className="width120px"><p>Дуусах</p></div></div>
							</div>
						</div>
					</div>
