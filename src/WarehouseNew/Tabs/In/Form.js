...
const Form = (props) => {
	...
	console.log(context.attributes.form)
			...
			returnHTML.push(
				<div className="box_container" key={Math.random()} style={{width: width}}>
					...
					<div className="box_header" style={{width: widths[5]}}>
						<select className="custom-select" style={{width: '100%', margin: '0 1rem 0 0', lineHeight: '18px'}} onChange={(e) => setType(e.target.value)}>
							{
								formsHTML
							}
						</select>
					...
					<div className="box_header" style={{width: widths[7]}}>
						<input type="number" style={{height: '30px'}} defaultValue={product.quantity} onKeyUp={(e) => quantity(e, product.uid)} defaultValue={product.quantity} />
					</div>
	...
	const send = () => {
		...
		if(type !== 'import' && document.getElementById('sendingWarehouse').value === '') {
			...
			alert('Орлогын төрөл сонгоно уу!')
			return
		}
		let foo = []
	...
	const foobar = props.form[1] === 'customer' || props.form[1] === 'warehouse' ? (
		<div style={{width: '320px'}}>
			...
			<div>
				<select id="sendingWarehouse" className="custom-select" style={{width: '300px', margin: '0 1rem 0 0'}} value={from} onChange={(e) => foo(e.target.value)}>
					...
					<div id="overlaypage_header">
						...
						<div style={{display: 'flex', width: '1280px'}}>
							...
							<div style={{width: '320px'}}>
								...
								<div>
									<select id="inboundTypes" className="custom-select" style={{width: '300px', margin: '0 1rem 0 0'}} value={inboundType} onChange={(e) => setInboundType(e.target.value)}>
										<option value="">--сонгоно уу--</option>
										{
