	...
	return (
		<div style={{padding: '0 1.5rem'}}>
			...
			<div className="box_header_container">
				...
				<div className="box_header" style={{width: widths[3]}}>Хүсэлт гаргасан агуулах/харилцагч</div>
				...
				<div className="box_header" style={{width: widths[6]}}>Баталсан огноо</div>
				<div className="box_header" style={{width: widths[6]}}>Баталсан хэрэглэгч</div>
				<div className="box_header" style={{width: widths[6]}}>Дүн</div>
			</div>
			<div>{renderHTML}</div>
		</div>
	)
