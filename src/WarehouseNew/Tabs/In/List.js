...
const List = (props) => {
  ...
  const warehouseList = useContext(ModuleContext);
        ...
        <div className="blah margintop8px" style={{ height: "60px" }}>
          ...
          <div className="blahblah">
            <div className="width100px">
              <p className="blahblahheader">Хүсэлтийн дугаар</p>
          ...
          <div className="blahblah">
            <div className="width100px">
              <p className="blahblahheader">Хөдөлгөөний төрөл</p>
              <select
                className="headerInputs"
          ...
          <div className="blahblah">
            <div className="width200px">
              <p className="blahblahheader">Орлого/Зарлагын төрөл</p>
              <select
                className="headerInputs"
                onChange={(e) => change(e.target.value, "type")}
              >
