            ...
            if(products[id].selected) {
                ...
                renderHTML.push(
                    ...
                    {businessTypes.map(type => {
                        ...
                        const channelPrice = product.locations['62f4aabe45a4e22552a3969f'].price.channel[type.business_type_id] ?? ''
                        return (
                            <td style={{fontSize: '10px', padding: '0', margin: '0'}}><input type="text" className="massPrice" defaultValue={channelPrice} /></td>
                            )
                    })}
                    </tr>
                    )
        ...
        <div id="overlaypage_bg">
            <div id="overlaypage">
                ...
                <div id="pageBody" style={{top: '60px', right: '0', bottom: '52px', left: '0'}}>
                    ...
                    <input className="marginleft1rem" type="file" id="input" onChange={(e) => foobar(e)} style={{width: '100px'}} />
                    </div>
