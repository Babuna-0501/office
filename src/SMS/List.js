...
const List = props => {
	...
	const fetchData = () => {
		...
		if (dateStart === "" && dateEnd === "") {
			let url = `https://api2.ebazaar.mn/api/get/smslog?page=${page}&date=${createvalue}&phone=${phonevalue}&response=${operatorvalue}&content=${descvalue}`;
			...
			let url = `https://api2.ebazaar.mn/api/get/smslog?page=${page}&date=${createvalue}&phone=${phonevalue}&response=${operatorvalue}&content=${descvalue}&start_date=${dateStart}&end_date=${dateEnd}`;
