...
const NotificationList = () => {
  ...
  let getNotif = () => {
    ...
    let testURL = `${process.env.REACT_APP_API_URL2}/api/notification/get?createdDate=${createdDate}&phoneNumber=${phoneNumber}&firstName=${userName}&title=${title}&body=${body}&backOfficeUser=${sender}&page=${page}&limit=${limit}`;
