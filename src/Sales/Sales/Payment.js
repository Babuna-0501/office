          ...
          >
            <div className='column5'>
              <span className='paymentmethod' onClick={() => fnCash()}>
                <img
                  src='https://admin.ebazaar.mn/images/paymentmethod/card.svg'
                  alt=''
                />
                <span>Бэлэн</span>
              </span>
            ...
            <div className='column5' onClick={() => fnWire()}>
              <span className='paymentmethod'>
                <img
                  src='https://admin.ebazaar.mn/images/paymentmethod/wire.svg'
                  alt=''
                />
                <span>Данс</span>
              </span>
            ...
            >
              <span className='paymentmethod'>
                <img
                  src='https://admin.ebazaar.mn/images/paymentmethod/qpay.svg'
                  alt=''
                />
                <span>QPAY</span>
              </span>
            ...
            >
              <span className='paymentmethod'>
                <img
                  src='https://admin.ebazaar.mn/images/paymentmethod/socialpay.svg'
                  alt=''
                />
                <span>SocialPay</span>
              </span>
