...
const Payment = (props) => {
	...
	const searchBusinessInfo = (e) => {
		if (e.key === "Enter") {
            ...
            if(e.target.value.length >= 7) {
				...
				let url = `https://api2.ebazaar.mn/pos-api/vatpayer?regNo=${e.target.value}`;
	...
	const fnCash = () => {
		const payingAmount = parseInt(document.getElementById('payingamount').value)
	...
	const renderCash = () => {
		return cash ? (
			<div className="columns">
				<div className="column2"><span>Бэлэн мөнгө:</span></div>
				<div className="column2" style={{textAlign: 'right'}}><span>{cash}</span></div>
			</div>
		) : null
	}
	const printTest = () => {
		...
		<div className="paymentpage_bg">
			<div className="paymentpage" style={{display: print ? 'none' : ''}}>
				<div className="leftblock">
					...
					<div className="columns">
						<div className="column1">
							<input type="number" id="payingamount" defaultValue={total} style={{height: '60px', fontSize: '1.5rem', fontWeight: 'bold', padding: '0 1rem'}} />
						</div>
					</div>
					<div className="columns margintop1rem" style={{padding: '0 1rem 0 0'}}>
						<div className="column5">
							<span className="paymentmethod" onClick={() => fnCash()}>
								<img src="https://admin.ebazaar.mn/images/paymentmethod/card.svg" alt="" />
								<span>Бэлэн</span>
							</span>
						</div>
						...
						<div className="column5" onClick={() => fnWire()}>
							<span className="paymentmethod">
								<img src="https://admin.ebazaar.mn/images/paymentmethod/wire.svg" alt="" />
								<span>Данс</span>
							</span>
						</div>
						<div className="column5" onClick={() => fnQpay()} style={{display: 'none'}}>
							<span className="paymentmethod">
								<img src="https://admin.ebazaar.mn/images/paymentmethod/qpay.svg" alt="" />
								<span>QPAY</span>
							</span>
						</div>
						<div className="column5" onClick={() => fnSocialpay()} style={{display: 'none'}}>
							<span className="paymentmethod">
								<img src="https://admin.ebazaar.mn/images/paymentmethod/socialpay.svg" alt="" />
								<span>SocialPay</span>
							</span>
						</div>
					</div>
					<div style={{padding: '0 2rem 0 0', position: 'absolute', right: '0', bottom: '1rem', left: '2rem'}}>
				...
				<div className="rightblock" id="foobarblah">
					<div className="columns">
						<div className="column2"><h1>Төлөх дүн:</h1></div>
						<div className="column2" style={{textAlign: 'right'}}><h1>{total.toLocaleString()} ₮</h1></div>
					</div>
					{cash ? (
						<div className="columns margintop1rem">
							...
							<div className="column2" style={{textAlign: 'right'}}>
								...
								<img onClick={() => setCash(false)} src="https://admin.ebazaar.mn/images/remove.svg" alt="" style={{height: '26px', margin: '0 0 0 1rem'}} />
							</div>
						</div>
					) : null}
					{card ? (
						<div className="columns margintop1rem">
							<div className="column2"><span>Карт:</span></div>
							<div className="column2" style={{textAlign: 'right'}}>
								<span>{card.toLocaleString()}</span>
								<img onClick={() => setCard(false)} src="https://admin.ebazaar.mn/images/remove.svg" alt="" style={{height: '26px', margin: '0 0 0 1rem'}} />
							</div>
						</div>
					) : null}
					{wire ? (
						<div className="columns margintop1rem">
							<div className="column2"><span>Данс:</span></div>
							<div className="column2" style={{textAlign: 'right'}}>
								<span>{wire.toLocaleString()}</span>
								<img onClick={() => setWire(false)} src="https://admin.ebazaar.mn/images/remove.svg" alt="" style={{height: '26px', margin: '0 0 0 1rem'}} />
							</div>
						</div>
					) : null}
					{qpay ? (
						<div className="columns margintop1rem">
							<div className="column2"><span>QPay:</span></div>
							<div className="column2" style={{textAlign: 'right'}}>
								<span>{qpay.toLocaleString()}</span>
								<img onClick={() => setQpay(false)} src="https://admin.ebazaar.mn/images/remove.svg" alt="" style={{height: '26px', margin: '0 0 0 1rem'}} />
							</div>
						</div>
					) : null}
					{socialpay ? (
						<div className="columns margintop1rem">
							<div className="column2"><span>SocialPay:</span></div>
							<div className="column2" style={{textAlign: 'right'}}>
								<span>{socialpay.toLocaleString()}</span>
								<img onClick={() => setSocialpay(false)} src="https://admin.ebazaar.mn/images/remove.svg" alt="" style={{height: '26px', margin: '0 0 0 1rem'}} />
							</div>
						</div>
					) : null}
					<div style={{position: 'absolute', right: '0', bottom: '0', left: '0', padding: '2rem '}}>
						<div className="columns margintop1rem">
							<div className="column2"><span>Нийт төлсөн дүн</span></div>
							<div className="column2" style={{textAlign: 'right'}}>
