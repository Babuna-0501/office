...
function Navigation(props) {
  ...
  const navigationItems = [
    ...
    {
      path: '/ordersuper',
      title: 'Захиалга SuperDeliv',
      icon: '/media/order.svg',
      show: props.userData.company_id === '|14268|'
    },
    {
      path: '/newOrders',
      title: 'Шинэ Захиалга',
        ...
        >
          ...
          >
            <div className='navItemWrapper'>
              <img src='/media/customers.svg' alt='Customer' height={30} />
              <span>Харилцагч</span>
            </div>
          </div>
        </Popover>
    ...
    },
    {
      path: '/noat',
      title: 'НӨАТ',
      icon: '/media/noat-target-uramshuulal-pbi.svg',
      show: permission?.noat?.read
    },
    {
      path: '/discount',
      title: 'Промо',
      icon: '/media/discount.svg',
    ...
    },
    {
      ...
      icon: '/media/shipment-warehouse.svg',
      show:
        permission?.shipment?.read && props.userData.company_id !== '|14005|'
    },
    {
      path: '/ship-ment',
    ...
    },
    {
      ...
      customContent: (
        ...
        >
          ...
          >
            <div className='navItemWrapper'>
              <img src={'/media/marketing.svg'} height={30} alt='Marketing' />
              <span>Маркетинг</span>
            </div>
          </div>
        </Popover>
              ...
              <>
                {item.customContent ? (
                  ...
                  <Link
                    ...
                    className={
                      currentPath.endsWith(item.path) ? 'nav active' : 'nav'
                    }
                    href={item.path}
                  >
                    <div className='navItemWrapper'>
