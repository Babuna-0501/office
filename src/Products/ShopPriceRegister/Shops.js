...
const Shops = (props) => {
  ...
  useEffect(() => {
    ...
    let url = `https://api2.ebazaar.mn/api/merchants?page=${page}`;
    // if (companyID.includes(appctx.userData.company_id)) {
    url = `https://api2.ebazaar.mn/api/merchants?page=${page}`;
    if (params !== "") {
      url = `https://api2.ebazaar.mn/api/merchants?${params}page=${page}`;
    }
    // } else {
    //   url = `https://api2.ebazaar.mn/api/tradeshop/requests?page=${page}`;
    //   if (params !== "") {
    //     url = `https://api2.ebazaar.mn/api/tradeshop/requests?${params}page=${page}`;
    //   }
    // }
