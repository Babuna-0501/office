...
const Product = props => {
	...
	const fetchData = () => {
		...
		fetch(
			`https://api2.ebazaar.mn/api/backoffice/suppliers?id=${product.vendor}`,
			requestOptions
		)
			.then(r => r.json())
			.then(res => {
					...
					<img
						src={
							supplierImage === undefined || supplierImage === ""
								? "https://ebazaar.mn/media/small/6451839791366876118714579441202301180039211652005125652064228302797616.jpg"
								: supplierImage
						}
						alt=""
						style={{
