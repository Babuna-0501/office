...
const Messenger = props => {
  ...
  const Fetchdata = () => {
    ...
    let url = `${process.env.REACT_APP_API_URL2}/api/chats?tradeshop_id=T${props.tx.tradeshop_id}&supplier_id=S13873`;
  ...
  const senMessageFunc = () => {
    ...
    // };
    // // let url = `https://api.ebazaar.link/api/chats/read`;
    // let url = `${process.env.REACT_APP_API_URL2}/api/chats/read`;
