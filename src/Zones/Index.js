...
const Index = React.memo((props) => {
  ...
  useEffect(() => {
    ...
    // `https://api2.ebazaar.mn/api/sfa/tradeshop/list?supplierId=${props.userData.company_id.replaceAll("|","")}`;
    ...
    fetch(`https://api2.ebazaar.mn/api/sfa/tradeshop/list`, requestOptions)
      .then((res) => res.json())
      .then((res) => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://api2.ebazaar.mn/api/zones?name=${namesearch}&start_date=${startdate}&end_date=${enddate}&priority=${priority}`,
      requestOptions
    )
      .then((r) => r.json())
      .then((response) => {
