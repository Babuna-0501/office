...
const List = (props) => {
    ...
    const fetchData = (pageNum) => {
        ...
        const url = `https://api2.ebazaar.mn/api/products/get1?${parameters}page=${page.current}&limit=10000&order_by=created_desc`
    ...
    try {
        data.map(product => {
            console.log('addddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii')
