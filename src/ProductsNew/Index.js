...
const Index = () => {
  ...
  const tabs = [
      ...
      content: (
        <>
			<div className="containerPageButtons productv2">
				<button className="pageButton" style={{marginRight:"5px"}}>Жагсаалтын багана солих</button>
    ...
    },
    {
      ...
      content:
	  	<div>
		    <button className="pageButton secondary marginleft1rem">Export</button>
    ...
    },
    {
      ...
      content: 
	  <div>
	   		<button className="pageButton secondary marginleft1rem">Ангилалын тохиргоо</button>
            <button className="pageButton secondary marginleft1rem">Брэндийн тохиргоо</button>
            <button className="pageButton secondary">Эрэмбийн тохиргоо</button>
            <button className="pageButton secondary">Мерчант АПП Эрэмбийн тохиргоо</button>
	  </div>,
    },
  ];
