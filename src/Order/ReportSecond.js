...
function ReportSecond(props) {
	...
	const getOrders = () => {
		...
		if (
			...
			// urlReport = `https://api2.ebazaar.mn/api/orders?delivery_start=${date_start?.value}&delivery_end=${date_end?.value}&page=all`;

			// urlReport = `https://api2.ebazaar.mn/api/orders?delivery_start=2023-06-01&delivery_end=2023-06-30&tradeshop_phone=95051516&page=all`;
		...
		if (
			...
			urlReport = `https://api2.ebazaar.mn/api/orders?order_type=1&delivery_start=${date_start?.value}&delivery_end=${date_end?.value}&page=all`;
		}
