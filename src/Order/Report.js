  ...
  const exporter = () => {
    ...
    if (startDate && endDate) {
      if (props.page.page[0] === 'shuurhai') {
        url = `${process.env.REACT_APP_API_URL2}/api/orders?order_type=1&vendor=20000&delivery_start=${startDate}&delivery_end=${endDate}&page=all`;
      } else {
        url = `${process.env.REACT_APP_API_URL2}/api/orders?order_type=1&delivery_start=${startDate}&delivery_end=${endDate}&page=all`;
      }
    }
    ...
    // url = `${process.env.REACT_APP_API_URL2}/api/orders?delivery_start=2022-04-01&delivery_end=2023-07-05&supplier_id=13884&page=all`;
