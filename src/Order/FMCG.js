...
function FMCG(props) {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://api2.ebazaar.mn/api/merchants/tradeshop?tradeshop_id=" +
  ...
  const send = () => {
    ...
    fetch("https://api.ebazaar.mn/api/cola/send_order", requestOptions)
      .then((r) => r.text())
      .then((response) => {
  ...
  const sendMGAG = () => {
    ...
    for (let term in terms) {
      ...
      let url = `https://api2.ebazaar.mn/api/discounts?skus=${stringify(
        skus
      )}&tradeshop_code=${tradeShopID}`;
      ...
      fetch(
        `https://api.ebazaar.mn/api/AGMG/bracket?tradeshop_code=${tradeShopID}&term_id=${term}`,
        requestOptions
      )
    ...
    fetch(`https://api2.ebazaar.mn/api/create/backofficelog`, backOfficeLog)
      .then((r) => r.json())
      .then((response) => {
    ...
    fetch("https://api.ebazaar.mn/api/AGMG/send_order", requestOptions)
      .then((r) => r.text())
      .then((response) => {
