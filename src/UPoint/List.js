...
const List = props => {
  ...
  const getData = () => {
    ...
    let url = `${process.env.REACT_APP_API_URL2}/api/upoint/data?user_id=${props?.searchID}&order_id=${props?.orderID}&start_date=${props.enteredDate}&end_date=${props.lastDate}&consume=${zar}&bonus=${addPoint}&returs=${added}`;
